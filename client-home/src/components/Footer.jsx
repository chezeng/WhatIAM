    ...
    return (
        ...
        <footer className="w-screen space-y-5 bg-black p-6 h-40">
            <div className="flex justify-between items-center ml-6 -mb-2">
                ...
                <li>
                    <a target="_blank" href="https://www.youtube.com/@chezeng" className="hover:underline">
                    YouTube
                    </a>
                </li>
                </ul>

                <a href="https://blog.chengzeng.dev" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 font-extrabold mt-6 mr-6 hover:underline">
                  【My World】
                </a>
            </div>
