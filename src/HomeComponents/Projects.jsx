...
import { SiFigma, SiPostman, SiFlask, SiPython, SiVite, SiVercel, SiTailwindcss, SiCreatereactapp, SiJetbrains, SiGodotengine, SiCanva, SiAdobeaftereffects, SiMongodb} from "react-icons/si";
          ...
          <div className='card-content'>
              ...
              <div className="px-6 py-4">
                ...
                <p className="text-slate-500 text-base mt-2">
                  Created an AI-powered app to provide immersive experiences by generating personalized audios and visuals with APIs such as Cohere, Groq, DELL-3, Luma and Suno AI.
                </p>
              </div>
              <div className="flex mt-3">
                <a href="https://github.com/ch3ngZ/Timeless" target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="grid grid-cols-4 ml-4 -mt-3">
                    ...
                    <IconWithTooltip icon={SiFigma} label="Figma" />
                    <div className="relative group flex items-center mx-1">
        ...
        <div className='card-wrapper h-[32rem] w-[20rem] hover:scale-105 transition ease-in-out mt-20'>
          <div className='card-content'>
              ...
              <div className="px-6 py-4">
                ...
                <p className="text-slate-500 text-base mt-2">
                Developed a dynamic portfolio and blog website using React, Express.js and MongoDB with advanced libraries
